<html lang="en">
    ...
    <cfif IsDefined('form.submit')>
        <cfif structKeyExists(URL, "pageid")>
            <cfset insert1 = createObject("component", "simple-cms-task.cms")>
				<cfset result =  insert1.updateRecord(form.pagename,form.pagedesc)>
                <cfelse>
                <cfset insert = createObject("component", "simple-cms-task.cms")>
			<cfset res =  insert.dataInsert(form.pagename,form.pagedesc)>
        </cfif>
